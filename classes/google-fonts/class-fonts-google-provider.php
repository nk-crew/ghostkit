...
if ( ! class_exists( 'Ghostkit_Fonts_Google_Provider' ) && class_exists( 'WP_Fonts_Provider' ) ) {
	/**
	 * Ghostkit_Fonts_Google_Provider class
	 *
	 ...
	 * 'google' webfonts {@see WP_Fonts_Provider::set_setfonts()}
	 * and then triggers {@see Ghostkit_Fonts_Google_Provider::get_css()}
	 ...
	 */
	class Ghostkit_Fonts_Google_Provider extends WP_Fonts_Provider {
