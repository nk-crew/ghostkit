        ...
        return (
            <ApplyFilters name="ghostkit.fonts.settings" props={ this.props }>
                <div className="ghostkit-settings-content-wrapper ghostkit-settings-fonts">
                    ...
                    <ExternalLink href="https://ghostkit.io/pricing/?utm_source=plugin&utm_medium=settings&utm_campaign=fonts&utm_content=@@plugin_version">https://ghostkit.io/pricing/</ExternalLink>
                </div>
            </ApplyFilters>
        );
    }
