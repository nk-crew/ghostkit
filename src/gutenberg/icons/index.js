...
import blockDivider from './block-divider.svg';
import blockDividerShape from './block-shape-divider.svg';
import blockGist from './block-gist.svg';
...
import blockWidgetizedArea from './block-widgetized-area.svg';
import blockTableOfContents from './block-table-of-contents.svg';
import blockForm from './block-form.svg';
import blockFormFieldCheckbox from './block-form-field-checkbox.svg';
import blockFormFieldDate from './block-form-field-date.svg';
import blockFormFieldEmail from './block-form-field-email.svg';
import blockFormFieldHidden from './block-form-field-hidden.svg';
import blockFormFieldName from './block-form-field-name.svg';
import blockFormFieldNumber from './block-form-field-number.svg';
import blockFormFieldPhone from './block-form-field-phone.svg';
import blockFormFieldRadio from './block-form-field-radio.svg';
import blockFormFieldSelect from './block-form-field-select.svg';
...
import iconTypographyGoogleFonts from './icon-google-fonts.svg';
import iconTypographyAdobeFonts from './icon-adobe-fonts.svg';
