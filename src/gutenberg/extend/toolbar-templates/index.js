...
class ToolbarTemplates extends Component {
    componentDidMount() {
        ...
        if ( $toolbar ) {
            const LibraryButton = () => (
                <div className="ghostkit-toolbar-templates">
