...
const TEMPLATE = [
    ...
    [ 'ghostkit/form-field-text', { slug: 'field_subject', label: __( 'Subject', '@@text_domain' ), required: true } ],
    [ 'ghostkit/form-field-textarea', { slug: 'field_message', label: __( 'Message', '@@text_domain' ), required: true } ],
                ...
                <InspectorControls>
                    <PanelBody title={ __( 'Mail', '@@text_domain' ) }>
                        ...
                        <BaseControl
                            ...
                            help={ __( 'In case if you don\'t want to receive email messages from this form, you may disable sending emails functionality.' ) }
                        >
                            <ToggleControl
                            ...
                            <ButtonGroup>
                                {
                                    [
                                        ...
                                        if ( ! confirmationType && 'message' === val.value ) {
                                            selected = true;
                                        }
