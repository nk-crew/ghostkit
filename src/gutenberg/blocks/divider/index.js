...
export const settings = {
    ...
    ghostkit: {
        ...
        customStylesCallback( attributes ) {
            const styles = {
                '--gkt-divider__border-width': 'undefined' !== typeof attributes.size ? `${ attributes.size }px` : undefined,
                '--gkt-divider__border-color': attributes.color,
                '--gkt-divider--icon__font-size': 'undefined' !== typeof attributes.iconSize ? `${ attributes.iconSize }px` : undefined,
