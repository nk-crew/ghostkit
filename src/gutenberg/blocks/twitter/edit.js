                                        ...
                                        <div className="ghostkit-twitter-item" key={ itemName }>
                                            ...
                                            <div className="ghostkit-twitter-item-content">
                                                ...
                                                { 'links_media' === feedTextConvertLinks ? (
                                                    // eslint-disable-next-line react/no-danger
                                                    <div className="ghostkit-twitter-item-text" dangerouslySetInnerHTML={ { __html: item.text_entitled } } />
                                                ) : '' }
                                                { 'links' === feedTextConvertLinks ? (
                                                    // eslint-disable-next-line react/no-danger
                                                    <div className="ghostkit-twitter-item-text" dangerouslySetInnerHTML={ { __html: item.text_entitled_no_media } } />
                                                ) : '' }
                                                { 'links_media' !== feedTextConvertLinks && 'links' !== feedTextConvertLinks ? (
                                                    // eslint-disable-next-line react/no-danger
                                                    <div className="ghostkit-twitter-item-text" dangerouslySetInnerHTML={ { __html: item.text } } />
                                                ) : '' }
                                                { showFeedActions ? (
