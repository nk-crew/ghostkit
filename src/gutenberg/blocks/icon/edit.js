...
const { useBlockProps, __experimentalUseBorderProps: useBorderProps } = wp.blockEditor;
...
export default function BlockEdit(props) {
  ...
  className = classnames(className, 'ghostkit-icon', borderProps.className);
  ...
  return (
    <>
      ...
      <span {...blockProps}>
        <Icon icon={attributes.icon} setAttributes={setAttributes} />
      </span>
    </>
  );
}

function Icon({ icon, setAttributes }) {
