...
import { BaseControl, Button, ExternalLink, PanelBody, SelectControl, TextareaControl } from '@wordpress/components';
...
export default function BlockEdit( props ) {
	...
	const { hasChildBlocks, editorSettings, photoImage } = useSelect( ( select ) => {
