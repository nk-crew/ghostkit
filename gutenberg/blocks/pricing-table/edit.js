...
import { AlignmentToolbar, BlockControls, InspectorControls, useBlockProps, useInnerBlocksProps } from '@wordpress/block-editor';
import { createBlock } from '@wordpress/blocks';
import { BaseControl, Button, PanelBody, Toolbar, ToolbarButton, ToolbarGroup } from '@wordpress/components';
...
export default function BlockEdit( props ) {
	...
	return (
		<div { ...blockProps }>
			...
			<InspectorControls>
				<PanelBody>
					<BaseControl id={ __( 'Vertical align', 'ghostkit' ) } label={ __( 'Vertical align', 'ghostkit' ) }>
						<div>
					...
					<BaseControl id={ __( 'Horizontal align', 'ghostkit' ) } label={ __( 'Horizontal align', 'ghostkit' ) }>
						<div>
							<AlignmentToolbar
								value={ horizontalAlign }
								onChange={ ( val ) => setAttributes( { horizontalAlign: val } ) }
